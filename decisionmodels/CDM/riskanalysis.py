...
class EllipseGenerator:
    ...
    def __init__(self, c1_location, c2_location, ego_location, c) -> None:
    ...
    def cal_risk_vector(self, car_location):
        ...
        """
        a = (
            cal_magnitude(cal_rel_location_curve(car_location - self.c1_location))
            + cal_magnitude(cal_rel_location_curve(car_location - self.c2_location))
        ) / 2
        b = math.sqrt(a * a - self.c * self.c)
